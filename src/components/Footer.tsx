			...
			<div className="max-w-7xl mx-auto px-6 relative z-10">
				<div className="grid md:grid-cols-12 gap-12 border-b border-white/20 pb-16 mb-12">
					...
					<div className="md:col-span-5 space-y-8">
						<div>
							<img
								src={federadaLogo}
								alt="Federada Logo"
								className="h-16 mb-6 invert opacity-90"
							/>
							<h2 className="sr-only">ATLÉTICA DE ADS</h2>
							<p className="text-gray-400 font-sans text-lg leading-relaxed">
								Fomentando tecnologia, esporte e integração no IFRO Campus
								Ji-Paraná desde 2024.
							</p>
						</div>
					...
					<div className="md:col-span-3 md:col-start-7">
						<h3 className="font-mono text-xs text-gray-500 mb-6 uppercase tracking-widest">
							// NAVEGAÇÃO
						</h3>
							...
							{["INÍCIO", "LOJA OFICIAL", "NOTÍCIAS", "SOBRE NÓS"].map(
								(item, i) => (
									<li key={i}>
										<a
											href="#"
											className="group flex items-center gap-2 hover:text-gray-300 transition-colors"
										>
					...
					<div className="md:col-span-3">
						...
						<ul className="space-y-4">
							<li>
								<a
									href="#"
									className="flex items-center justify-between border-b border-white/10 pb-2 group hover:border-white transition-colors"
								>
									<span>INSTAGRAM</span>
									<ArrowUpRight
										size={18}
