...
const boardMembers = [
  { role: "PRESIDENTE", name: "Hyago Alves", image: hyagoImg, instagram: "https://instagram.com/hyagoalvs", col: "col-span-1 md:col-span-2" },
  { role: "VICE-PRESIDENTE", name: "Pedro Batista", image: pedroImg, instagram: "https://instagram.com/phmelobatista", col: "col-span-1 md:col-span-2" },
  { role: "SECRETÁRIO GERAL", name: "Augusto Ignácio", image: augustoImg, instagram: "https://instagram.com/caadsifro" },
  { role: "VICE-SECRETÁRIA GERAL", name: "Nathalia Lopes", image: nathaliaImg, instagram: "https://instagram.com/_nathallia" },
  { role: "DIRETORA FINANCEIRA", name: "Kauane Izidoro", image: kauaneImg, instagram: "https://instagram.com/kim_izidoro" },
  { role: "VICE-DIRETORA FINANCEIRA", name: "Tainara Leal", image: tainaraImg, instagram: "https://instagram.com/tainaraa_ll" },
  { role: "DIR. MARKETING & IMPRENSA", name: "Vanessa Mikaelly", image: vanessaImg, instagram: "https://instagram.com/vssmky" },
  { role: "VICE-DIR. MKT & IMPRENSA", name: "Anna Beatriz", image: annaImg, instagram: "https://instagram.com/caadsifro" },
  { role: "DIR. EVENTOS & ESPORTES", name: "Gabriel Lucena", image: gabrielImg, instagram: "https://instagram.com/biels_l" },
  { role: "VICE-DIR. EVENTOS", name: "Filipe Lopes", image: filipeImg, instagram: "https://instagram.com/fimaciel13" },
  { role: "DIR. RELAÇÕES ACADÊMICAS", name: "Guilherme Tavares", image: guilhermeImg, instagram: "https://instagram.com/guimtavs" },
  { role: "VICE-DIR. REL. ACADÊMICAS", name: "Thállyta Amorim", image: thallytaImg, instagram: "https://instagram.com/amorim._tata" },
];
...
export default function CAADS() {
  useEffect(() => {
    // Tenta carregar o script do Instagram se ainda não existir
  ...
  return (
    <section className="py-24 bg-white text-black border-t border-black relative overflow-hidden" id="caads">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-12 gap-12">
          ...
          {/* LEFT COLUMN: PROPOSALS & SPOTLIGHT */}
          <div className="md:col-span-4 space-y-8">
             <FadeIn delay={100}>
               ...
               <div className="space-y-4">
                 {proposals.map((prop) => (
                   <div key={prop.id} className="group border border-gray-200 p-6 hover:border-black hover:bg-neutral-50 transition-all duration-300">
               ...
               <div className="mt-12">
                  ...
                  <div className="border border-black bg-neutral-50 p-4 relative group overflow-hidden max-w-full">
                     <div 
                       className="instagram-embed-container"
                       dangerouslySetInnerHTML={{ __html: `
                        <blockquote class="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/p/DUWlpzuDexx/?utm_source=ig_embed&amp;utm_campaign=loading" data-instgrm-version="14" style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);"></blockquote>
                       `}}
                     />
                     <div className="mt-3 flex justify-between items-center">
                        <span className="font-mono text-[10px] text-gray-400">@CAADSIFRO</span>
                        <a href="https://instagram.com/caadsifro" target="_blank" rel="noopener noreferrer" className="text-xs font-bold flex items-center gap-1 hover:text-blue-600">
