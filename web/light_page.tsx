          ...
          <div className="max-w-6xl mx-auto relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              ...
              <p className="text-slate-600 text-base max-w-xl mb-4">
                Explore os campeonatos dispon├¡veis, junte-se a uma equipe e inscreva-se para competir nas maiores disputas universit├írias.
              </p>
              
              {!user && (
                <div className="bg-gray-50 rounded-2xl px-6 py-4 border border-gray-200 inline-block mt-2">
                  <p className="font-medium text-sm text-gray-700 flex items-center gap-2"><Shield size={16}/> Voc├¬ n├úo est├í logado.</p>
                  <p className="text-xs text-gray-500 mt-1">Fa├ºa login para se vincular a uma equipe.</p>
                </div>
              )}
            </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 mb-8">
                    ...
                    <div className="flex gap-2">
                      ...
                      >
                        ...
                        <option value="OPEN">Inscri├º├Áes Abertas</option>
                    ...
                    if (championships.length === 0) {
                      return (
                        <div className="text-center py-24 bg-white border border-gray-200 rounded-3xl shadow-sm">
                          ...
                          <p className="text-gray-500 mt-2">A temporada est├í tranquila no momento.</p>
                        </div>
                      );
                    }
                        ...
                        {filtered.map(champ => {
                          ...
                          switch(champ.status) {
                            ...
                            case 'OPEN':
                              ...
                              badgeText = isOpen ? 'Inscri├º├Áes Abertas' : 'Inscri├º├Áes Encerradas';
                              badgeColor = isOpen ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700';
                              break;
                            case 'CLOSED':
                            case 'GENERATING_BRACKET':
                              badgeText = 'Inscri├º├Áes Encerradas';
